...
public class CategoryIndexServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		long category_count = (long)em.createNamedQuery("getCategoryCount", Long.class)
		        .getSingleResult();
		em.close();
		...
		RequestDispatcher rd = request.getRequestDispatcher("/WEB-INF/views/category/index.jsp");
